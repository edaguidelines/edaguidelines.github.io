...
appropriate time interval (e.g., 10 seconds [7]). However, Dawson et al. [12] suggests to correct the range of SCL by following formula:<br>
 𝐶𝑜𝑟𝑟𝑒𝑐𝑡𝑒𝑑𝑆𝐶𝐿 = (𝑆𝐶𝐿 − 𝑆𝐶𝐿𝑚𝑎𝑥)/(𝑆𝐶𝐿𝑚𝑎𝑥 − 𝑆𝐶𝐿𝑚𝑖𝑛)<br>
